  ...
  return (
    <div className="bg-[#0c0c0c] text-white overflow-hidden">
      ...
      <section className="cta-section w-full">
        {/* Main row - Form left, Image right - altezza fissa per tutta la riga */}
        <div className="grid lg:grid-cols-2 lg:h-[480px]">
          {/* Left - Title + Form */}
          <div className="bg-[#111] px-6 lg:px-16 xl:px-24 py-10 lg:py-12 flex flex-col justify-center">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-12 h-px bg-amber-500" />
              <span className="text-amber-500 text-sm font-bold uppercase tracking-widest">Contattaci</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-black leading-[0.95] mb-3">
              INIZIA IL TUO <span className="text-white/40">PROGETTO</span>
            </h2>
            <p className="text-white/50 text-sm leading-relaxed mb-5">
              Compila il form per ricevere un preventivo gratuito.
            </p>

            {/* Contact Form compatto */}
            <form className="space-y-3">
              <div className="grid sm:grid-cols-2 gap-3">
                <input
                  type="text"
                  placeholder="Nome *"
                  className="w-full bg-white/5 border border-white/10 px-4 py-2.5 text-white text-sm placeholder:text-white/30 focus:outline-none focus:border-amber-500 transition-colors"
                  required
                />
                <input
                  type="tel"
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-white/5 border border-white/10 px-4 py-2.5 text-white text-sm placeholder:text-white/30 focus:outline-none focus:border-amber-500 transition-colors resize-none"
              />
              <button
                type="submit"
                className="group inline-flex items-center gap-3 bg-amber-500 hover:bg-amber-400 text-black font-bold px-6 py-3 text-sm uppercase tracking-wider transition-all duration-300"
              >
                Invia Richiesta
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          {/* Right - Immagine che riempie tutto */}
          <div className="hidden lg:block relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between">
              <div>
                <span className="block text-2xl font-black text-amber-500">30+</span>
                <span className="text-white/60 text-xs uppercase tracking-wider">Anni</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-white">100+</span>
                <span className="text-white/60 text-xs uppercase tracking-wider">Progetti</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-white">3</span>
                <span className="text-white/60 text-xs uppercase tracking-wider">Generazioni</span>
              </div>
            </div>
          </div>
        </div>

        {/* Bottom row - Contact methods */}
        <div className="grid grid-cols-2 lg:grid-cols-4">
          <a
            href="tel:3408491759"
            className="group flex items-center gap-4 px-4 lg:px-6 py-5 bg-[#0c0c0c] border-t border-r border-white/10 hover:bg-white/5 transition-colors"
          >
            ...
            <div className="min-w-0">
              <p className="text-white/40 text-xs uppercase tracking-wider">Telefono</p>
              <p className="text-white text-sm font-bold group-hover:text-amber-500 transition-colors truncate">340 849 1759</p>
            </div>
          </a>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-white text-sm font-bold group-hover:text-green-500 transition-colors truncate">Scrivici ora</p>
            </div>
          </a>

          <div className="flex items-center gap-4 px-4 lg:px-6 py-5 bg-[#0c0c0c] border-t border-r border-white/10">
            ...
            <div className="min-w-0">
              <p className="text-white/40 text-xs uppercase tracking-wider">Sede</p>
              <p className="text-white text-sm font-bold truncate">Corteno Golgi (BS)</p>
            </div>
          </div>

          <div className="flex items-center gap-4 px-4 lg:px-6 py-5 bg-[#0c0c0c] border-t border-white/10">
            <div className="w-10 h-10 bg-white/10 flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="min-w-0">
              <p className="text-white/40 text-xs uppercase tracking-wider">Orari</p>
              <p className="text-white text-sm font-bold truncate">Lun - Ven 8-18</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0c0c0c]">
        <div className="grid lg:grid-cols-2 lg:h-[500px]">
          ...
          <div className="h-[350px] lg:h-full">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2766.8!2d10.2456!3d46.1642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47831f7d5b7d5d5d%3A0x1234567890abcdef!2sVia%20Mazzini%2C%20110%2C%2025040%20Corteno%20Golgi%20BS!5e0!3m2!1sit!2sit!4v1699999999999!5m2!1sit!2sit"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
              ...
              title="Mappa sede Impresa Edile Eredi Bianchi"
              className="grayscale hover:grayscale-0 transition-all duration-500"
            ></iframe>
          </div>

          {/* Right - Text */}
          <div className="bg-[#111] px-6 lg:px-16 xl:px-24 py-12 lg:py-0 flex flex-col justify-center">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-[2px] bg-amber-500"></div>
              <span className="text-amber-500 text-sm font-bold uppercase tracking-wider">Dove Siamo</span>
            </div>
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
              Vieni a trovarci
            </h2>
            <p className="text-white/60 text-lg">
              La nostra sede si trova nel cuore della Val Camonica, a Corteno Golgi. Siamo facilmente raggiungibili e sempre pronti ad accoglierti per discutere del tuo prossimo progetto.
            </p>
          </div>
        </div>
      </section>
